...
public class KruskalMinimumSpanningTreeTest {
    ...
    public static void main(String[] args) {
        testMinimumSpanningTree(new KruskalMinimumSpanningTree(loadGraph()));
    ...
    private static void testMinimumSpanningTree(KruskalMinimumSpanningTree kruskalMinimumSpanningTree) {
        ...
        int i = 0;
        for (EdgeWeightedGraph.Edge edge : kruskalMinimumSpanningTree.edges()) {
            assert edges[i].toString().equals(edge.toString());
            i++;
        }

        assert kruskalMinimumSpanningTree.weight() == 1.81;
    }
}
